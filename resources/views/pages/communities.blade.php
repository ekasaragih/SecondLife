        ...
        <div class="w-full mx-auto rounded">
            <form>
                <div class="mb-4 border-2 rounded-md">
                    <input type="text" id="post" name="post" class="w-full px-3 py-2 border-b border-gray-300 font-semibold" placeholder="Title">
                    <input type="textarea" id="post" name="post" class="w-full h-40 px-3 py-2 pt-0" placeholder="Share your thoughts">
                </div>
        ...
        <div id="post-card" class="mt-5">
            <div id="post" class="rounded-lg shadow-md p-3 border-2 m-1">
                <div class="flex items-center p-3">
                    <img class="w-8 h-8 rounded-full mr-4" src="https://cdn.antaranews.com/cache/1200x800/2023/03/13/4E7F573F-B89D-40E4-AE6F-56C06AD96496.jpeg" alt="Profile Picture">
                ...
                <p class="text-gray-800 pl-3">Do you think it's worth to barter my corkcickle with a book called "Before the coffee gets cold", I really want to have this book and I can not find it in any bookstore</p>
            ...
            <div id="replies" class="w-11/12 rounded-lg shadow-md p-5 border-2 m-1 float-right flex items-center">
                <img class="w-8 h-8 rounded-full mr-4" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSUAl5RnJ7_Y5MWYXPkxtFAM5eahD7k9RjDDQ&s" alt="Profile Picture">
                <h2 class="text-lg font-semibold mr-3">Mark Lee</h2>
                <h2 class="text-base text-gray-500 italic">March 24, 2024</h2>
                <p class="text-gray-800 pl-3">YASHH! You're totally missing a lot</p>
            </div>
            <div id="replies" class="w-11/12 rounded-lg shadow-md p-5 border-2 m-1 float-right flex items-center">
                <img class="w-8 h-8 rounded-full mr-4" src="https://i.pinimg.com/736x/cc/c3/e6/ccc3e6081e3b11da3eb6f16d625b45c9.jpg" alt="Profile Picture">
