            ...
            <div id="post-card" class="mt-5 mb-5">
                <div id="post" class="rounded-lg shadow-md p-3 border-2 m-1">
                    <div class="flex items-center p-3">
                        ...
                        <h2 class="text-lg font-semibold mr-3">
                            <a href="{{ route('userProfile', ['username' => $community->UserID->us_username]) }}"
                                class="text-[#F12E52] hover:underline">
                ...
                <div class="replies-container"
                    ...
                    <div id="replies"
                        ...
                        <h2 class="text-lg font-semibold mr-3">
                            <a href="{{ route('userProfile', ['username' => $feedback->UserID->us_name]) }}"
                                class="text-[#F12E52] hover:underline">
