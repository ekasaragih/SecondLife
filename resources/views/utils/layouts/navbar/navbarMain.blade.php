<nav class="hidden xl:block lg:block mb-5">
    <ul class="flex justify-center gap-24">
        <li class="relative text-xl">
            ...
            <ul id="explore-dropdown"
                class="hidden absolute bg-white mt-2 w-96 border border-gray-200 rounded-lg shadow-lg z-10">
                <li><a href="{{ route('explore') }}#swape"
                        class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Explore</a></li>
                <li><a href="{{ route('explore') }}#recommendationLocation"
                        class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Based on Your Location</a></li>
                <li><a href="{{ route('explore') }}#trendingPrediction"
                        class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Trending Now</a></li>
            </ul>
        </li>
        ...
        <li class="relative text-xl" id="categories-menu">
            ...
            <ul id="categories-dropdown"
                ...
                <li><a href="{{ route('categories') }}#category"
                        class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Category</a></li>
                <li><a href="{{ route('categories') }}#recommendation"
                        class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Based on Your Preference</a>
                </li>
            </ul>
        </li>
        ...
        <li class="relative text-xl" id="communities-menu">
            ...
            <ul id="communities-dropdown"
                class="hidden absolute bg-white mt-2 w-64 border border-gray-200 rounded-lg shadow-lg z-10">
                <li><a href="{{ route('communities') }}"
