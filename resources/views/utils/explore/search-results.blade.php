        ...
        <div class="flex flex-col items-center justify-center h-full">
            ...
            <div class="flex space-x-4">
                <a href="{{ route('about_us') }}"
                    class="bg-purple-500 hover:bg-purple-600 text-white px-4 py-2 rounded-md">Back to Home</a>
                <a href="{{ route('contact_us') }}"
                    class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md">Contact Us</a>
            </div>
        </div>
        @else
