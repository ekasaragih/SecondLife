    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="w-full p-6 mt-8 bg-white border border-gray-200 rounded-lg shadow-lg">
            ...
            <ul class="list-disc list-inside mb-4">
                ...
                <li>Sending promotional emails about new products, special offers, or other information which we think
                    you
                    may
                    find
                    interesting</li>
            ...
            <p class="mb-4">
                ...
                Cookies
                allow
                web applications to respond to you as an individual. The web application can tailor its operations to
                your
                needs,
            ...
            <ul class="list-disc list-inside mb-4">
                ...
                <li>We will not sell, distribute, or lease your personal information to third parties unless we have
                    your
                    permission
                ...
                <li>You may request details of personal information which we hold about you. If you would like a copy of
                    the
                    information held on you, please write to [Your Company Name, Address, City, State, Zip Code] or
                    email
                    [email protected]</li>
                <li>If you believe that any information we are holding on you is incorrect or incomplete, please write
                    to or
                    email
            ...
            <a href="/"
                class="mt-16 text-sm text-center font-medium rounded-lg text-gray-500 underline sm:w-fit hover:text-opacity-75">Back
                to home</a>
        </div>
    </div>
</div>