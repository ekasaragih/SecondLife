...
<div class="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-4 gap-2">
    ...
    <div class="max-w-md rounded overflow-hidden shadow-lg product-card" style="display: block; height: 550px;">
        ...
        <div class="px-6 py-4">
            <input type="text" id="goods_owner" value="{{ $product->us_ID }}" />
...
<div class="text-3xl text-[#F12E52]"><b>Recommendation</b><span class="font-bold text-sm text-gray-600">based on your
        preferences</span></div><br>
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="grid grid-cols-4 sm:grid-cols-4 md:grid-cols-4 lg:grid-cols-4 gap-4">
        ...
        return !in_array($product->id, collect(json_decode(request()->cookie('wishlist') ??
        '[]'))->pluck('id')->toArray());
        })->shuffle()->take(8);
        @endphp
